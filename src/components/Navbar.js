  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className={`form-check form-switch mx-3 text-${props.mode==='light'?'dark':'light'}`}>
        ...
        <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{props.textRed}</label>
      </div>

      <div className={`form-check form-switch mx-3 text-${props.mode==='light'?'dark':'light'}`}>
        <input className="form-check-input" onClick={props.toggleMode2} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
        <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{props.textGreen}</label>
      </div>
...
Navbar.propTypes = {
    title : PropTypes.string.isRequired,  // to tell this thing is required we have to pass it
